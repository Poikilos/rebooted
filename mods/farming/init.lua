...
minetest.register_craft({
	output = "farming:cake",
	recipe = {
		{"farming:flour", "farming:wheat", "farming:flour"},
...
minetest.register_node("farming:wheat_block", {
	description = "wheat block",
	tiles = {"farming_wheat_block_top.png", "farming_wheat_block_top.png", "farming_wheat_block.png"},
...
minetest.register_node("farming:cake", {
	...
	inventory_image = "minecraft_cake.png",
	wield_image = "minecraft_cake.png",
      groups = {crumbly=3},
	paramtype = "light",
	drop = "farming:cake",
	...
	node_box = {
	    type = "fixed",
		fixed = {  {-0.43, -0.50, -0.43, 0.43, -0.06, 0.42}, }
      },
      selection_box = {
        type = "fixed",
	    fixed = {
