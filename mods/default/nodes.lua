...
light_source = LIGHT_MAX - 1,
tiles = {"glowstone.png"},
inventory_image = minetest.inventorycube("glowstone.png"),
paramtype = "light",
drop = "default:lantern",
...
minetest.register_node("default:pumpkin", {
	...
	tiles = {"pumpkin_top.png", "pumpkin_top.png", "pumpkin_side.png",
	        "pumpkin_side.png", "pumpkin_side.png", "pumpkin_side.png",},
      is_ground_content = true,
	groups = {crumbly=3,soil=1},
	sounds = default.node_sound_dirt_defaults(),
})

minetest.register_node("default:decoration_pumpkin", {
	description = "halloween_pumpkin",
	tiles = {"pumpkin_top.png", "pumpkin_top.png", "pumpkin_side.png",
	        "pumpkin_side.png", "pumpkin_side.png", "pumpkin_front.png",},
      is_ground_content = true,
	groups = {crumbly=3,soil=1},
	sounds = default.node_sound_dirt_defaults(),
})

minetest.register_node("default:iron_ladder", {
	description = "iron ladder",
	drawtype = "signlike",
	tiles = {"default_iron_ladder.png"},
	inventory_image = "default_iron_ladder.png",
	wield_image = "default_iron_ladder.png",
	paramtype = "light",
	paramtype2 = "wallmounted",
	walkable = false,
	climbable = true,
